            ...
            <div className="row">
                    ...
                    <div className="owl-carousel testimonial-carousel position-relative">
                        <div className="d-flex flex-column text-white">
                            <div className="d-flex align-items-center mb-3">
                                <img className="img-fluid" src="img/ceo.png" alt=""/>
                                <div className="ml-3">
                        ...
                        <div className="d-flex flex-column text-white">
                            <div className="d-flex align-items-center mb-3">
                                <img className="img-fluid" src="img/emek.png" alt=""/>
                                <div className="ml-3">
                        ...
                        <div className="d-flex flex-column text-white">
                            <div className="d-flex align-items-center mb-3">
                                <img className="img-fluid" src="img/hnm.png" alt=""/>
                                <div className="ml-3">
                ...
                <div className="col-lg-5" >
                    <div className="position-relative h-100 rounded overflow-hidden">
                        <img className="position-absolute w-100 h-100" src="img/hold.webp" />
                    </div>
                </div>
            </div>
        </div>
